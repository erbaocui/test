	...
	<table style="padding: 5px" width="100%">
		<tr>
			...
			<td valign="bottom" align="right" width="50%">
				<font size="3">&nbsp;&nbsp;<strong>欢迎：</strong>${currentUser.loginName }(${currentUser.name })【${currentMemberShip.group.name }】</font>
			</td>
		</tr>
	</table>
</div>
...
<div region="west" style="width: 200px" title="导航菜单" split="true">
	<div class="easyui-accordion" data-options="fit:true,border:false">
		...
		<c:forEach items="${currentUser.roles}" var="keyword" varStatus="id" >
			<c:if test="${keyword.id=='xs' }">
